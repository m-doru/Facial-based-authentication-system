...
(
    ...
    casia_train_labels,
) = casia_classifier.get_train_features_and_labels(True, mlbp_feature_computer)
print("Loaded casia training features")
(
    casia_test_features,
    casia_test_labels,
) = casia_classifier.get_test_features_and_labels(True, mlbp_feature_computer)
print("Loaded casia test features")

(
    mfsd_train_features,
    mfsd_train_labels,
) = msu_mfsd_classifier.get_train_features_and_labels(True, mlbp_feature_computer)
print("Loaded msu mfsd training features")
(
    mfsd_test_features,
    mfsd_test_labels,
) = msu_mfsd_classifier.get_test_features_and_labels(True, mlbp_feature_computer)

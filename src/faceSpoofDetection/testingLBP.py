...
faceImg = get_frame_from_video.get_frames(
    "/home/doru/Desktop/Licenta/Implementation/databases"
    "/MSU_USSA/MSU_USSA_Public/LiveSubjectsImages/109.jpg"
)[0]
spoofFaceImg = get_frame_from_video.get_frames(
    "/home/doru/Desktop/Licenta/Implementation/databases"
    + "/MSU_USSA/MSU_USSA_Public/SpoofSubjectImages/"
    + medium
    + "/109.jpg"
)[0]
...
for box in bb:
    alignedFaces.append(
        align.align(
            260, faceImg, box, landmarkIndices=openface.AlignDlib.OUTER_EYES_AND_NOSE
        )
    )

...
def get_train_features_and_labels(load_train_features, mlbp_feature_computer = None):
    ...
    if load_train_features == False:
        ...
        real_features_train = dbfeatures.compute_face_features_idiap(mlbp_feature_computer, stage='train', real=True,
                                                                     verbose=True)
        ...
        spoof_features_train = dbfeatures.compute_face_features_idiap(mlbp_feature_computer, stage='train', real=False,
                                                                      verbose=True)
...
def get_test_features_and_labels(load_test_features, mlbp_feature_computer = None):
    ...
    if load_test_features == False:
        real_features_test = dbfeatures.compute_face_features_idiap(mlbp_feature_computer, stage='devel', real=True,
                                                                    verbose=True)
        joblib.dump(real_features_test,saved_realfaces_test_features_filename)

        spoof_features_test = dbfeatures.compute_face_features_idiap(mlbp_feature_computer, stage='devel', real=False,
                                                                     verbose=True)
